package by.tc.task03.server.dao.impl;
...
public class StudentServerDAOImpl implements StudentServerDAO {
    ...
    private static final String STUDENTS_XML = "src/main/resources/students_database.xml";
    private static final String USERS_XML = "src/main/resources/users_database.xml";
